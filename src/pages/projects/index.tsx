...
export default function index() {
    return (
        <div className={styles.container}>
            ...
            <div className={styles.gridContainer}>
                <div className={styles.descriptionContainer}>
                    <h3 className={styles.heading}>Campus Explorer</h3>
                    <p className={styles.descriptionContainer}> A web app that enables users to query over ubc course
                        and room
                    ...
                    <p className={styles.descriptionContainer}> Campus explorer was an opportunity for me to flex my
                        react skills
            ...
            <div className={styles.gridContainer}>
                <div className={styles.descriptionContainer}>
                    ...
                    <p className={styles.descriptionContainer}> Expense tracker was a chance for me to further develop
                        my
